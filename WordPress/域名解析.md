...
进入阿里云控制台 -&gt; 域名 -&gt; 点击购买的域名后“解析”![](/WordPress/images/1.png)-记录类型：选择A，即将域名指向一个IPV4地址
主机记录：主机记录录是二级域名，我申请的是www二级域名，因此此处填www。一个主域名可以添加多个二级域名分别指向不同的网站服务器。比如：www.baidu.com mail.baidu.com image.baidu.com ... 这里的www, mail, image都是二级域名
